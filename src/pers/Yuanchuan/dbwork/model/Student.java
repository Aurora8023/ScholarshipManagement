...
public class Student {
    ...
    private final SimpleStringProperty major;//专业号


    public Student(String id,String name,String sex,int year,
                   String type,String idcard,String khyh,
                   String yhkh,String banji,String major){
